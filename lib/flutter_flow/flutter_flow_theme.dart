...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color tertiary = const Color(0xFFA5D6A7);
  late Color alternate = const Color(0xFFC8E6C9);
  late Color primaryText = const Color(0xFF1B5E20);
  ...
  late Color accent1 = const Color(0xFF66BB6A);
  late Color accent2 = const Color(0xFFC5E1A5);
  late Color accent3 = const Color(0xFFD0E9C6);
  late Color accent4 = const Color(0xFFA5D6A7);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color tertiary = const Color(0xFFA5D6A7);
  late Color alternate = const Color(0xFFB2DFDB);
  late Color primaryText = const Color(0xFFE0F2F1);
  late Color secondaryText = const Color(0xFFB2DFDB);
  late Color primaryBackground = const Color(0xFF1B5E20);
  late Color secondaryBackground = const Color(0xFF2E7D32);
  late Color accent1 = const Color(0xFF4CAF50);
  late Color accent2 = const Color(0xFFA5D6A7);
  late Color accent3 = const Color(0xFFB2DFDB);
  late Color accent4 = const Color(0xFFC8E6C9);
